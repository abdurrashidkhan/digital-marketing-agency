          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className=" bg-[#fff] dark:bg-[#192536] shadow-2xl rounded">
              ...
              <div className="">
                ...
                <p className="text-sm dark:text-[#d6d6d6]">Search Engine Optimization (SEO) enhances website visibility in search engine results, boosting organic traffic through strategic keyword optimization, content quality improvement, and technical enhancements.</p>
                </div>
              </div>
            </div>
          </div>
